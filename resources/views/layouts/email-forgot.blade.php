...
<div class="container"
        ...
        <div class="title" style="font-size: 24px; font-weight: bold; margin-top: 20px; color: #333; text-align: center;">
            KYC-XEPAYS - Reset Password</div>
        <div class="content" style="margin-top: 20px; color: #333; text-align: left;">
            <h3>Hello,</h3>
            <p>{!! $body !!}</p>
        </div>
        <a href="{{ $action_link }}" class="button"
            style="display: block; width: 100%; text-align: center; background-color: #ff0000; color: #ffffff; text-decoration: none; padding: 10px; border-radius: 5px; margin-top: 20px;">Reset Password</a>
