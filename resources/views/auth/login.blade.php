                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">KYC-XEPAYS-Login</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        ...
                        <form id="formAuthentication" class="mb-3" action="" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="email" name="email"
                                    value="{{ old('email', isset($_COOKIE['email']) ? $_COOKIE['email'] : '') }}"
                            ...
                            <div class="mb-3">
                                <button class="btn btn-primary d-grid w-100" value="submit" type="submit"
